...
export default class Calculator extends Component {
    ...
    setOperation(operation) {
        ...
        if (this.state.current === 0) {
            this.setState({ operation: n_operation, current: 1, clearDisplay: true })
        } else {
            ...
            this.setState({
                ...
                operation: equals ? null : n_operation,
                current: equals ? 0 : 1,
                clearDisplay: !equals,
                values
            })
    ...
    render() {
        return (
            <div className="calculator">
                ...
                <Button label='x' click={this.setOperation} operation></Button>
